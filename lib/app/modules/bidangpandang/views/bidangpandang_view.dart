        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Container(
                  child: Image.asset("assets/image/bidangpandang/longshot.jpg"),
                ),
              ),
              SizedBox(height: 25),
              Text(
              ...
              Center(
                child: Container(
                  child: Image.asset("assets/image/bidangpandang/fullshot.png"),
                ),
              ),
              SizedBox(height: 20),
              Text(
              ...
              Center(
                child: Container(
                  width: Get.width,
                  child: Image.asset("assets/image/bidangpandang/closeup.jpg",
                      fit: BoxFit.contain),
                ),
              ),
              SizedBox(height: 25),
